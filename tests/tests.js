...
exports.defineManualTests = function(contentEl, createActionButton) {
  ...
  createActionButton('Open Image', function() {
    cordova.plugins.bridge.open(
      'https://raw.githubusercontent.com/cordova-bridge/open/test/test.png', 'application/pdf'
      success, error);
  }, 'open-file');

  createActionButton('Open PDF', function() {
    cordova.plugins.bridge.open(
      'https://raw.githubusercontent.com/cordova-bridge/open/test/test.pdf', 'application/pdf'
      success, error);
  }, 'open-file');
};
